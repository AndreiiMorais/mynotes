      ...
      child: Scaffold(
        ...
        body: BlocConsumer<CounterBloc, CounterState>(
          listener: (context, state) {
            //o listener executa essa função a cada vez q tiver alguma alteração de estado
            //no caso ele limpa o campo de texto
            _controller.clear();
          },
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                            //forma correta para mandar evento para o bloc.
